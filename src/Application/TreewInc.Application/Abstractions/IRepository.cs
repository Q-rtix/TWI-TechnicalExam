...
{
	IQueryable<TEntity> GetMany(Expression<Func<TEntity, bool>>[]? filters, bool asNoTracking = false, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderBy = null);
